...
const Spotlight = () => {
  ...
  const spotlightItems = [
    { name: "Koramangala Villa", img: "/spotlight/spotlight-img-1.jpg" },
    { name: "Whitefield Residence", img: "/spotlight/spotlight-img-2.jpg" },
    { name: "Tech Hub Office", img: "/spotlight/spotlight-img-3.jpg" },
    { name: "Indiranagar Duplex", img: "/spotlight/spotlight-img-4.jpg" },
    { name: "HSR Layout Home", img: "/spotlight/spotlight-img-5.jpg" },
    { name: "Jayanagar Classic", img: "/spotlight/spotlight-img-6.jpg" },
    { name: "Sarjapur Villa", img: "/spotlight/spotlight-img-7.jpg" },
    { name: "Electronic City Office", img: "/spotlight/spotlight-img-8.jpg" },
    { name: "Bellandur Apartment", img: "/spotlight/spotlight-img-9.jpg" },
    { name: "Marathahalli Penthouse", img: "/spotlight/spotlight-img-10.jpg" },
  ];
