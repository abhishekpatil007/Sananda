              ...
              <div className="link services-link">
                ...
                <div className={`submenu ${servicesOpen ? 'open' : ''}`}>
                  ...
                  <a
                    ...
                    onClick={(e) => handleLinkClick(e, "/services/constructions")}
                  >
                    <p>Constructions</p>
                  </a>
                  <a
                    href="/services/interior-designs"
                    onClick={(e) => handleLinkClick(e, "/services/interior-designs")}
                  >
                    <p>Interior Designs</p>
                  </a>
                  <a
                    href="/services/furniture-designs"
                    onClick={(e) => handleLinkClick(e, "/services/furniture-designs")}
                  >
                    <p>Furniture Designs</p>
                  </a>
                  <a
                    href="/services/office-interior"
                    onClick={(e) => handleLinkClick(e, "/services/office-interior")}
                  >
                    <p>Office Interior Setup</p>
                  </a>
                </div>
              </div>
              <div className="link">
